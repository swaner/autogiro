...
class VisitorFactory
{
     ...
     */
    const VISITOR_IGNORE_EXTERNAL = 8;  // self::VISITOR_IGNORE_ACCOUNTS | self::VISITOR_IGNORE_AMOUNTS | self::VISITOR_IGNORE_IDS;

    /**
     * Create the standard set of visitors used when processing a parse tree
     */
    public function createVisitors($flags = null)
    {
